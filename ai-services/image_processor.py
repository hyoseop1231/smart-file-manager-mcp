...
class ImageProcessor:
            ...
            if hasattr(img, '_getexif') and img._getexif() is not None:
                ...
                for tag_id, value in exif.items():
                    ...
                    try:
                        ...
                        json_value = self._convert_to_json_serializable(value)
                        if json_value is not None:
                            exif_data[tag] = json_value
                    except Exception as e:
                        # Skip problematic EXIF values
                        self.logger.debug(f"Skipping EXIF tag {tag}: {e}")
                        continue
        except Exception as e:
    ...
    def _convert_to_json_serializable(self, value):
        ...
        try:
            ...
            # Handle IFDRational (from PIL.ExifTags)
            ...
            # Return None for completely unparseable values
            return None
